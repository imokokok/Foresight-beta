...
const CATEGORY_STYLES: Record<string, CategoryStyle> = {
  ...
  default: {
    chip: "bg-slate-50 text-slate-700 border-slate-100 hover:bg-slate-100",
    chipActive:
      "bg-gradient-to-r from-slate-700 to-slate-900 text-white shadow-slate-200/80 shadow-md border-transparent",
    badge: "bg-slate-100 text-slate-800",
    border: "border-slate-100 hover:border-slate-200",
    softBg: "bg-gradient-to-br from-slate-50/70 to-white/0",
    accentText: "text-slate-600",
    activeCard: "bg-white/85 border-indigo-100 shadow-md shadow-indigo-100/60 scale-[1.02]",
    accentBar: "bg-indigo-500",
    chatGradient: "from-indigo-100/70 via-purple-50/60 to-white/0",
    headerGradient: "from-indigo-500/90 to-purple-500/90",
    frameSurfaceGradient: "from-indigo-50/70 via-purple-50/60 to-white/0",
  },
};
