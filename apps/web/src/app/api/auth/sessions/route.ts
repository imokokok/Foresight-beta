...
export async function GET(req: NextRequest) {
  try {
    ...
    if (error) {
      ...
      return ApiResponses.databaseError("Failed to load sessions", error.message);
    }
    ...
    return successResponse({ sessions, currentSessionId });
  } catch (e: any) {
    return ApiResponses.internalError("Failed to load sessions", String(e?.message || e));
  }
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (error) {
      ...
      return ApiResponses.databaseError("Failed to revoke session", error.message);
    }
    ...
    return ApiResponses.internalError("Failed to revoke session", String(e?.message || e));
  }
}
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    if (error) {
      ...
      return ApiResponses.databaseError("Failed to revoke sessions", error.message);
    }
    ...
    return ApiResponses.internalError("Failed to revoke sessions", String(e?.message || e));
  }
}
